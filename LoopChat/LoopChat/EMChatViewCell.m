...
{
    [self routerEvenWithName:kResendButtonTapEventName userInfo:@{kShouldResendCell:self}];
}
...
- (EMChatBaseBubbleView *)bubbleViewForMessageModel:(MessageModel *)messageModel
{
    switch (messageModel.type) {
        ...
        {
            return [[EMChatBaseBubbleView alloc] init];
        }
            break;
...
+ (CGFloat)bubbleViewHeightForMessageModel:(MessageModel *)messageModel
{
    switch (messageModel.type) {
        case eMessageBodyType_Text:
        {
            return [EMChatBaseBubbleView heightForBubbleWithObject:messageModel];
        }
            break;
        case eMessageBodyType_Image:
        {
